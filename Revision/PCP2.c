...
int main(){
	int a;
	char lname[50];
	printf("Please what is your name?");
	scanf("%s", lname);
	loop1:
	printf("What is your music genre of interest? Press 1 for Pop. Press 2 for 		Rhythm and Blues. Press 3 for Folk. Press 4 for Classical music. \n");
	scanf("%d",&a);
	pthread_t pop;
	pthread_t rnb;
	pthread_t folk;
